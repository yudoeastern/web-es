      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex-shrink-0">
            <img src="/logo.png" alt="EasternStack" className="h-12 w-auto" />
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            {/* AI Solutions - Direct link to /solutions */}
            <Link href="/solutions" className="px-4 py-2 text-gray-800 hover:text-[#E31E24] font-medium transition-colors">
              AI Solutions
            </Link>
        ...
        <div className="lg:hidden fixed inset-0 top-16 bg-white z-[9998]" style={{overflowY: 'auto'}}>
          <div className="p-4">
            ...
            <div className="space-y-2">
              ...
              {/* AI Solutions - Direct link for mobile */}
              <Link href="/solutions" className="block py-3 text-gray-700 border-b border-gray-100" onClick={handleLinkClick}>
                AI Solutions
              </Link>
