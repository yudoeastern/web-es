...
export type AgentOsView = "docs" | "chat" | "studio" | "runtime";
...
const NAV: {
  section: string;
  items: { id: AgentOsView | "api"; label: string; icon: (p: IconProps) => ReactNode; count?: number }[];
}[] = [
...
export function AgentOsShell({
  ...
  active: AgentOsView;
  onNavigate: (view: AgentOsView) => void;
  header: ReactNode;
  children: ReactNode;
}) {
  return (
    <div className="flex h-full bg-white text-slate-700">
      ...
      <aside className="hidden w-56 shrink-0 flex-col border-r border-slate-200 bg-white md:flex">
        <div className="flex items-center gap-2.5 px-4 pb-4 pt-5">
          <img src="/logo_head.png" alt="Eastern Stack AI" className="h-8 w-8 rounded-md" />
          <div className="leading-[1.1]">
            <p className="text-[11px] font-extrabold tracking-widest text-[#E31E24]">EASTERN</p>
            <p className="text-[11px] font-extrabold tracking-widest text-slate-900">
              STACK <span className="text-[#E31E24]">AI</span>
            </p>
          </div>
        </div>
