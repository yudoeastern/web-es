          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Lower operational cost</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">99%</div>
                <div className="text-text-secondary text-sm">Document accuracy</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">24/7</div>
                <div className="text-text-secondary text-sm">Automated decisions</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={item.step} className="text-center relative">
                ...
                {item.step !== "5" && (
                  <div className="hidden md:block absolute top-8 left-1/2 w-full h-0.5 bg-gradient-to-r from-primary-orange to-primary-orange-dark"></div>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Document Verification</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Identity Verification</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Credit Risk Assessment</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Income Verification</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Instant Decisioning</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Fraud Detection</h3>
              <p className="text-text-secondary">
      ...
      <section className="section-padding bg-bg-light-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">For Lenders</h3>
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">For Borrowers</h3>
              <ul className="space-y-3">
                <li className="flex items-start text-text-secondary">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
