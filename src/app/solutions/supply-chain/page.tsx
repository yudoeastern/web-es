    ...
    <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Lower inventory costs</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">50%</div>
                <div className="text-text-secondary text-sm">Fewer stockouts</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">25%</div>
                <div className="text-text-secondary text-sm">Reduced logistics cost</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">95%</div>
                <div className="text-text-secondary text-sm">Forecast accuracy</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Demand Forecasting</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Inventory Optimization</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Disruption Prediction</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Procurement Automation</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Logistics Optimization</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Supplier Risk Management</h3>
              <p className="text-text-secondary">
      ...
      <section className="section-padding bg-bg-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🏭 Manufacturing</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🛒 Retail & E-commerce</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">💊 Healthcare & Pharma</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🍔 Food & Beverage</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🚗 Automotive</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">⚡ Energy & Utilities</h3>
              <p className="text-text-secondary text-sm">
