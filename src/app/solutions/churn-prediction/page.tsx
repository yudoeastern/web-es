    ...
    <div className="min-h-screen">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-text-secondary mb-6">
              Acquiring a new customer costs <strong className="text-primary-orange">5-25x more</strong> than retaining an existing one. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Cheaper to retain than acquire</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">85%</div>
                <div className="text-text-secondary text-sm">Prediction accuracy</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">30%</div>
                <div className="text-text-secondary text-sm">Churn reduction</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Data Integration</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Pattern Analysis</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Risk Scoring</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Actionable Insights</h3>
              <p className="text-text-secondary text-sm">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Predictive Analytics</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Customer Segmentation</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Early Warning Alerts</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Explainable AI</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Retention Playbooks</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">ROI Tracking</h3>
              <p className="text-text-secondary">
      ...
      <section className="section-padding bg-bg-light-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">📱 Telecommunications</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">💳 SaaS & Subscription</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🏦 Banking & Finance</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🛒 E-commerce & Retail</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">📺 Streaming & Media</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">🏋️ Fitness & Wellness</h3>
              <p className="text-text-secondary text-sm">
