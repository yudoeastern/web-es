...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/solutions/ai/copilot-suite" },
  openGraph: {
    title: "Enterprise AI Copilot Suite for HR, Legal & Operations | EasternStack",
    description:
      "Role-based AI copilots for HR, legal, and operations teams — automate routine work, surface real-time insights, and integrate with enterprise tools.",
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Context Aware Assistance</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Task Automation</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Real Time Insights</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Seamless Integration</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Continuous Improvement</h3>
              <p className="text-text-secondary">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">HR Copilot</h3>
              <p className="text-text-secondary mb-6">
                Streamline recruitment, onboarding, and employee workflows with intelligent assistance.
              </p>
              <h4 className="text-sm font-semibold text-text-dark mb-3">Capabilities</h4>
              <ul className="space-y-2 text-text-secondary text-sm">
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-[#E31E24] rounded-full mr-2"></span>
                  Candidate Screening
                </li>
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-[#E31E24] rounded-full mr-2"></span>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Legal Copilot</h3>
              <p className="text-text-secondary mb-6">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Operations Copilot</h3>
              <p className="text-text-secondary mb-6">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">Role Based AI Assistants</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">Workflow Automation</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">Decision Support</h3>
              <p className="text-text-secondary text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-dark mb-3">Enterprise Integration</h3>
              <p className="text-text-secondary text-sm">
