        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/solutions/ai/ai-assistant" className="card group">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 group-hover:text-primary-orange-light transition-colors">
                AI Assistant
              </h3>
      ...
      <section className="section-padding bg-[#0F0F0F]">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-white mb-3">Context Aware Intelligence</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-white mb-3">Task Execution Across Systems</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-white mb-3">Workflow Orchestration</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-white mb-3">Multi Model Flexibility</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-white mb-3">Secure and Controlled Deployment</h3>
              <p className="text-gray-600">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Discovery & Assessment</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Solution Design</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Optimization & Scaling</h3>
              <p className="text-gray-600">
