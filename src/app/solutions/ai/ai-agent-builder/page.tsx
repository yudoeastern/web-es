        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Visual Workflow Design</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Multi Agent Orchestration</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Dynamic Task Execution</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">System Integration</h3>
              <p className="text-gray-600">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Scalable Deployment</h3>
              <p className="text-gray-600">
      ...
      <section className="section-padding bg-bg-lighter">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Agent Development Environment</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Workflow Orchestration Engine</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Integration Framework</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Execution and Monitoring Layer</h3>
              <p className="text-gray-600 text-sm">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">End to End Process Automation</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Data Processing Pipelines</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Operational Workflow Automation</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Customer Interaction Workflows</h3>
              <p className="text-gray-600 text-sm">
