        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Automated Data Extraction</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Document Classification</h3>
              <p className="text-text-gray">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Clause and Risk Analysis</h3>
              <p className="text-text-gray">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Summarization and Insight Generation</h3>
              <p className="text-text-gray">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Cross Document Comparison</h3>
              <p className="text-text-gray">
      ...
      <section className="section-padding bg-dark-bg">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-text-white mb-3">Document Processing Engine</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-white mb-3">Structured Data Output</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-white mb-3">Risk and Compliance Insights</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-white mb-3">Searchable Intelligence Layer</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-text-white mb-3">Integration Layer</h3>
              <p className="text-text-gray text-sm">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Legal and Contract Management</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Finance and Accounting</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Compliance and Audit</h3>
              <p className="text-text-gray text-sm">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-white mb-3">Procurement and Vendor Management</h3>
              <p className="text-text-gray text-sm">
