          ...
          <div id="invoice" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Key Features</h3>
          ...
          <div id="identity" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="card">
                  <div className="p-6">
                    <div className="text-sm text-gray-600 mb-4">SUPPORTED DOCUMENTS</div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-bg-light-card rounded-lg p-4 text-center">
                        <div className="text-3xl mb-2">🇮🇩</div>
                        <div className="text-[#1A1A1A] text-sm">KTP Indonesia</div>
                      </div>
                      <div className="bg-bg-light-card rounded-lg p-4 text-center">
                        <div className="text-3xl mb-2">🪪</div>
                        <div className="text-[#1A1A1A] text-sm">SIM / Driver License</div>
                      </div>
                      <div className="bg-bg-light-card rounded-lg p-4 text-center">
                        <div className="text-3xl mb-2">🛂</div>
                        <div className="text-[#1A1A1A] text-sm">Passport</div>
                      </div>
                      <div className="bg-bg-light-card rounded-lg p-4 text-center">
                        <div className="text-3xl mb-2">📄</div>
                        <div className="text-[#1A1A1A] text-sm">NPWP / Tax ID</div>
                      </div>
                    </div>
                  </div>
                </div>
