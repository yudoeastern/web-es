          ...
          <div id="customer-support" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Use Cases</h3>
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Why It's Powerful</h3>
              ...
              <div className="card">
                <div className="text-center py-8">
                  ...
                  <div className="text-text-secondary mb-6">Support Coverage</div>
                  <div className="text-5xl font-bold gradient-text mb-2">70%</div>
                  <div className="text-text-secondary mb-6">Workload Reduction</div>
                  <div className="text-5xl font-bold gradient-text">1000+</div>
                  <div className="text-text-secondary">Concurrent Users</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="sales-assistant" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="card">
                  <div className="p-6">
                    <div className="text-sm text-text-secondary mb-4">EXAMPLE CONVERSATION</div>
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="bg-bg-light-card rounded-lg p-3 text-text-secondary text-sm">
                      ...
                      <div className="flex items-start gap-3 flex-row-reverse">
                        ...
                        <div className="bg-primary-orange/10 border border-primary-orange/20 rounded-lg p-3 text-text-secondary text-sm">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Capabilities</h3>
                <ul className="space-y-2">
                  <li className="flex items-start text-text-secondary">
                    <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
          ...
          <div id="ai-tutor" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Applications</h3>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start text-text-secondary">
                    <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Value Proposition</h3>
                <ul className="space-y-2">
                  <li className="flex items-start text-text-secondary">
                    <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
              ...
              <div className="card">
                <div className="text-center py-8">
                  ...
                  <div className="text-text-secondary mb-6">Personalized Attention</div>
                  <div className="text-5xl font-bold gradient-text mb-2">Adaptive</div>
                  <div className="text-text-secondary mb-6">Learning Pace</div>
                  <div className="text-5xl font-bold gradient-text">24/7</div>
                  <div className="text-text-secondary">Always Available</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="work-assistant" className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="card">
                  <div className="p-6">
                    <div className="text-sm text-text-secondary mb-4">WORKFLOW EXAMPLE</div>
                    <div className="space-y-4">
                      <div className="bg-bg-light-card rounded-lg p-4 border-l-4 border-primary-orange">
                        <div className="text-text-dark font-semibold mb-2">📄 Document Upload</div>
                        <div className="text-text-secondary text-sm">User uploads 50-page PDF report</div>
                      </div>
                      ...
                      <div className="bg-primary-orange/10 border border-primary-orange/20 rounded-lg p-4">
                        <div className="text-text-dark font-semibold mb-2">🤖 AI Processing</div>
                        <div className="text-text-secondary text-sm">AI analyzes and extracts key information</div>
                      </div>
                      <div className="flex items-center justify-center">
                        <svg className="w-6 h-6 text-primary-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                      ...
                      <div className="bg-bg-light-card rounded-lg p-4 border-l-4 border-primary-orange">
                        <div className="text-text-dark font-semibold mb-2">📋 Summary Output</div>
                        <div className="text-text-secondary text-sm">5-page executive summary with key points</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-lg font-semibold text-text-dark mb-3">Functions</h3>
                <ul className="space-y-2">
                  <li className="flex items-start text-text-secondary">
                    <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="card">
                <div className="text-center py-8">
                  ...
                  <div className="text-text-secondary mb-6">Leave, Payroll, Policies</div>
                  <div className="text-5xl font-bold gradient-text mb-2">IT</div>
                  <div className="text-text-secondary mb-6">Tech Support Bot</div>
                  <div className="text-5xl font-bold gradient-text">KB</div>
                  <div className="text-text-secondary">Searchable Knowledge</div>
                </div>
              </div>
            </div>
          </div>
