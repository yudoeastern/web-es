          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Faster issue resolution</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">99.9%</div>
                <div className="text-text-secondary text-sm">Network uptime</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-bg-lighter">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">📡 Network Optimization</h3>
              <p className="text-text-secondary">Predictive maintenance and traffic optimization for better network performance.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">🔄 Churn Prediction</h3>
              <p className="text-text-secondary">Identify at-risk customers and proactively retain them.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">💬 Customer Support</h3>
              <p className="text-text-secondary">24/7 AI chatbots for billing, technical support, and plan recommendations.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">🛡️ Fraud Detection</h3>
              <p className="text-text-secondary">Detect SIM box fraud, subscription fraud, and usage anomalies.</p>
            </div>
          </div>
        </div>
      </section>
