...
import ConsultingFlow from "@/components/industries/ConsultingFlow";
import WeastCta from "@/components/WeastCta";

export const metadata: Metadata = {
  title: "AI for Consulting: Research, Diligence & Deliverables | EasternStack",
  description:
    "Agentic consulting operations on WEAST: market research, due diligence, report generation, and firm-wide knowledge management, one workspace per engagement.",
  alternates: { canonical: "/industries/consulting" },
  openGraph: {
    title: "AI for Consulting: Research, Diligence & Deliverables | EasternStack",
    description:
      "One workspace per client engagement: agents research markets, run diligence, and assemble cited deliverables, while every past project becomes searchable firm knowledge on one WEAST platform.",
    url: "https://easternstack.ai/industries/consulting",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 1200,
        alt: "EasternStack, AI for Consulting",
      },
    ],
  },
};
...
const USE_CASES = [
  {
    ...
    body: "An industry-reports knowledge base, MCP connections to external data sources, and synthesis subagents that produce a market analysis report.",
    icon: (
  ...
  },
  {
    ...
    body: "Target documents read via IDP, cross-referenced against regulations and sanctions lists, with delegation for material contracts and a risk matrix report.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "Template reports assembled by multi-subagent synthesis, with chart generation and citation building, producing a PDF-ready deliverable.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "Ingests every project document, stays searchable across engagements, and serves the other agents as the firm's oracle.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "Industry reports, financial statements, and company documents with hybrid search across documents and table extraction from financial statements.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const GOVERNANCE = [
  {
    ...
    body: "Each client engagement runs in its own workspace, with its own data, agents, and audit trail.",
  },
  {
    title: "Citations on every recommendation",
    body: "Each claim points back to source documents, so reviewers see the evidence behind the answer.",
  },
  {
    title: "Partners approve deliverables",
    body: "Agents draft and synthesize; partners review and sign off before anything reaches the client.",
  },
  {
    title: "Tenant boundaries per client",
    body: "Client data stays isolated between tenants, with boundaries enforced at the platform level.",
  },
  {
    title: "Sovereign deployment",
    body: "Run WEAST in your own environment when client confidentiality or internal policy requires it.",
  },
];

const OUTCOMES = [
  { stat: "Faster first draft", label: "from raw data to structured deliverable" },
  { stat: "Every claim cited", label: "evidence trails clients can check" },
  { stat: "One platform", label: "research, diligence, reporting, and knowledge under one governed WEAST" },
];
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600">
              One workspace per client engagement. Agents that research markets, run
              diligence, and assemble cited deliverables, while every past project becomes
              searchable firm knowledge, on one WEAST platform.
            </p>
            ...
            <p className="mt-5 text-[13px] text-gray-500">
              One workspace per engagement · Cited deliverables · Partner-approved
            </p>
          </div>
        </div>
      </section>

      {/* Animated synthesis funnel */}
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-white md:text-4xl">
              Deliverables assembled from living knowledge
            </h2>
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#1A1A1A] sm:text-4xl">
              What consulting teams build on WEAST
            </h2>
          </div>
