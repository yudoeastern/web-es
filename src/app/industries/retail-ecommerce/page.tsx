          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Revenue increase</div>
              </div>
              <div className="card text-center">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Personalized Recommendations</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Inventory Optimization</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Customer Service Automation</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Visual Search</h3>
              <p className="text-text-secondary mb-4">
