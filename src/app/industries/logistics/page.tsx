          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Lower fuel costs</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">40%</div>
                <div className="text-text-secondary text-sm">Faster deliveries</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">99%</div>
                <div className="text-text-secondary text-sm">On-time rate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-bg-lighter">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">🗺️ Route Optimization</h3>
              <p className="text-text-secondary">AI-powered route planning that reduces fuel costs and delivery time.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">📦 Fleet Management</h3>
              <p className="text-text-secondary">Real-time vehicle tracking and maintenance prediction.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">⏱️ ETA Prediction</h3>
              <p className="text-text-secondary">Accurate delivery time predictions using traffic and weather data.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">🏭 Warehouse Automation</h3>
              <p className="text-text-secondary">Automated sorting, picking, and inventory management.</p>
            </div>
          </div>
        </div>
      </section>
