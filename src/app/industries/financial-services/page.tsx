...
export default function FinancialServicesPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card text-center">
                ...
                <div className="text-text-secondary text-sm">Faster loan approval</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">60%</div>
                <div className="text-text-secondary text-sm">Fraud reduction</div>
              </div>
              <div className="card text-center">
                <div className="text-4xl font-bold gradient-text mb-2">24/7</div>
                <div className="text-text-secondary text-sm">Customer service</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Automated Loan Processing</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Fraud Detection & AML</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Customer Service Chatbots</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-4">Robo-Advisory</h3>
              <p className="text-text-secondary mb-4">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <h2 className="text-3xl md:text-4xl font-bold text-text-dark mb-8 text-center">
            BUILT FOR INDONESIA'S FINANCIAL LANDSCAPE
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-3">🇮🇩 Local Compliance</h3>
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-3">🗣️ Bahasa Indonesia NLP</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-3">📱 Mobile-First</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-3">🔒 Data Security</h3>
              <p className="text-text-secondary">
