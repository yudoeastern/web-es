...
import BiAgentFlow from "@/components/industries/BiAgentFlow";
import WeastCta from "@/components/WeastCta";

export const metadata: Metadata = {
  title: "AI for Financial Services: Banking, Insurance & Fintech | EasternStack",
  description:
    "Agentic business intelligence, automated loan processing, KYC document intelligence, and 24/7 customer service for banks and fintech in Indonesia, built for BI and OJK alignment on the WEAST platform.",
  alternates: { canonical: "/industries/financial-services" },
  openGraph: {
    title: "AI for Financial Services: Banking, Insurance & Fintech | EasternStack",
    description:
      "Agentic business intelligence, credit analysis, KYC document intelligence, and 24/7 customer service on one governed WEAST platform, built for Indonesia's financial landscape.",
    url: "https://easternstack.ai/industries/financial-services",
...
const USE_CASES = [
  {
    ...
    body: "A durable pipeline where agents validate, transform, and visualize your data, then answer stakeholder questions in natural language.",
    icon: (
  ...
  },
  {
    ...
    body: "Document verification, credit spreading, and approval workflows that turn weeks of manual processing into minutes.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "KTP, NPWP, salary slips, and statements become indexed, searchable knowledge with per-document cost tracking.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "Conversational support in Bahasa Indonesia and English for balances, cards, complaints, and applications.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Robo-Advisory",
    body: "Risk profiling, portfolio recommendations, and rebalancing alerts that bring advisory to mass-market customers.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const INDONESIA = [
  {
    title: "BI & OJK alignment",
    body: "Workflows designed around Bank Indonesia and OJK expectations, including consumer protection and reporting duties.",
  },
  {
    title: "Data sovereignty",
    body: "WEAST runs in your cloud account, your VPC, or your own data center, so customer data stays in the country.",
  },
  {
    title: "Bahasa Indonesia NLP",
    body: "Language understanding trained on Indonesian patterns, slang, and regional dialects for accurate interactions.",
  },
  {
  ...
  },
  {
    ...
    body: "Encryption, access controls, tenant boundaries, and run-level audit trails your auditors can replay.",
  },
];

const OUTCOMES = [
  { stat: "Upload → dashboard", label: "raw files become validated, visualized answers in one sitting" },
  { stat: "Every answer", label: "traceable back to the data and steps that produced it" },
  { stat: "One platform", label: "BI, credit, KYC, and service teams share the same governed WEAST" },
];
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600">
              Agentic business intelligence, credit analysis, KYC document intelligence, and
              24/7 customer service, governed on one WEAST platform built for Indonesia&apos;s
            ...
            <p className="mt-5 text-[13px] text-gray-500">
              BI & OJK aligned · Data sovereignty · Full audit trails
            </p>
          </div>
        </div>
      </section>

      {/* Animated fraud case flow */}
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-xs font-semibold uppercase tracking-widest text-[#E31E24]">
              Inside a WEAST BI team
            </p>
            <h2 className="mt-3 text-3xl font-bold text-white md:text-4xl">
              Agents that run your BI like a real team
            </h2>
            <p className="mt-4 text-zinc-400">
              Validation checks quality, transform builds the model, analytics generates the
              widgets, the BI lead reviews, and the answer agent serves every stakeholder
              question in natural language. Every path is traced.
            </p>
          </div>
          <div className="mt-12">
            <BiAgentFlow />
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#1A1A1A] sm:text-4xl">
              What financial teams run on WEAST
            </h2>
          </div>
