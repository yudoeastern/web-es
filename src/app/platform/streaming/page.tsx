        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">High-Throughput Ingestion</h3>
              <p className="text-text-secondary mb-4">
                Ingest millions of events per second from multiple sources with guaranteed delivery.
              </p>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Real-Time Processing</h3>
              <p className="text-text-secondary mb-4">
                Process and analyze streaming data in real-time with sub-second latency.
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Real-Time Analytics</h3>
              <p className="text-text-secondary mb-4">
                Gain instant insights with real-time dashboards and anomaly detection.
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Event Sourcing</h3>
              <p className="text-text-secondary mb-4">
                Build event-driven architectures with complete audit trails and state reconstruction.
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section-padding bg-gradient-to-br from-primary-orange-dark to-bg-light">
        <div className="container-custom text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Build event-driven architecture with sub-second latency for instant insights.
          </p>
          <Link href="/contact" className="btn-primary bg-white text-primary-orange hover:bg-bg-light">
            Start Streaming Journey
          </Link>
        </div>
      </section>
    </div>
