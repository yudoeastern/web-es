        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">High-Throughput Ingestion</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">Real-Time Processing</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">Real-Time Analytics</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">Event Sourcing</h3>
              <p className="text-gray-600 mb-4">
