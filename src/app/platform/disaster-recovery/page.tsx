        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Uptime SLA</h3>
              <p className="text-text-secondary text-sm">Guaranteed availability with multi-region redundancy.</p>
            </div>

            <div className="card text-center">
              <div className="text-5xl font-bold gradient-text mb-2">&lt;1hr</div>
              <h3 className="text-lg font-semibold text-text-dark mb-2">Recovery Time</h3>
              <p className="text-text-secondary text-sm">Rapid failover to minimize business disruption.</p>
            </div>

            <div className="card text-center">
              <div className="text-5xl font-bold gradient-text mb-2">&lt;5min</div>
              <h3 className="text-lg font-semibold text-text-dark mb-2">Recovery Point</h3>
              <p className="text-text-secondary text-sm">Minimal data loss with continuous replication.</p>
            </div>

            <div className="card text-center">
              <div className="text-5xl font-bold gradient-text mb-2">24/7</div>
              <h3 className="text-lg font-semibold text-text-dark mb-2">Monitoring</h3>
              <p className="text-text-secondary text-sm">Round-the-clock infrastructure surveillance.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Pilot Light</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Warm Standby</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Multi-Site Active</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Backup & Restore</h3>
              <p className="text-text-secondary mb-4">
