        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Massive Parallel Processing</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Columnar Storage</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">ML Integration</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Cost Optimization</h3>
              <p className="text-text-secondary mb-4">
