        ...
        <div className="container-custom text-center">
          <div className="inline-block mb-6 px-4 py-2 bg-white border border-border-color rounded-full shadow-sm">
            <span className="text-primary-orange text-sm font-semibold">
              Security Monitoring powered by TrueWatch
            </span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-text-dark mb-6">
            INTELLIGENT{" "}
            <span className="gradient-text">SECURITY MONITORING</span>
          </h1>
          <p className="text-xl text-text-secondary max-w-4xl mx-auto">
            AI-powered security monitoring and threat detection with TrueWatch's advanced surveillance technology.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Real-Time Surveillance</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Threat Detection</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Video Analytics</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Incident Response</h3>
              <p className="text-text-secondary mb-4">
                Automated incident response workflows with escalation and reporting.
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section-padding bg-gradient-to-br from-primary-orange-dark to-bg-light">
        <div className="container-custom text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Deploy AI-powered security monitoring with TrueWatch's intelligent surveillance.
          </p>
