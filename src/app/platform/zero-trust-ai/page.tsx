        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Never Trust, Always Verify</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Data Protection</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Compliance Ready</h3>
              <p className="text-text-secondary">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Model Access Control</h3>
              <p className="text-text-secondary text-sm mb-4">
                Role-based permissions with zero-trust architecture for AI model access.
              </p>
              <ul className="space-y-2 text-text-secondary text-sm">
                <li className="flex items-start">
                  <svg className="w-4 h-4 text-primary-orange mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Data Leakage Prevention</h3>
              <p className="text-text-secondary text-sm mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Prompt Injection Defense</h3>
              <p className="text-text-secondary text-sm mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Secure RAG Pipeline</h3>
              <p className="text-text-secondary text-sm mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Audit & Compliance</h3>
              <p className="text-text-secondary text-sm mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-3">Policy Guardrails</h3>
              <p className="text-text-secondary text-sm mb-4">
