        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">60% Cost Reduction</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Zero Downtime</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Enhanced Performance</h3>
              <p className="text-text-secondary">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Assessment</h3>
              <p className="text-text-secondary text-sm">Analyze current infrastructure and identify migration candidates.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Planning</h3>
              <p className="text-text-secondary text-sm">Create detailed migration plan with timeline and risk mitigation.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Testing</h3>
              <p className="text-text-secondary text-sm">Validate migration in staging environment before production move.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Migration</h3>
              <p className="text-text-secondary text-sm">Execute phased migration with real-time monitoring and rollback capability.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-text-dark mb-2">Optimization</h3>
              <p className="text-text-secondary text-sm">Fine-tune performance and costs post-migration for maximum ROI.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-2">Alibaba Cloud</h3>
              <p className="text-text-secondary text-sm mb-4">Leading cloud provider in Asia with comprehensive AI and data services.</p>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-2">Huawei Cloud</h3>
              <p className="text-text-secondary text-sm mb-4">Enterprise-grade cloud with strong focus on security and compliance.</p>
              <ul className="text-left text-sm text-text-secondary space-y-2">
            ...
            <div className="card text-center">
              <div className="text-4xl mb-4">🚀</div>
              <h3 className="text-xl font-semibold text-text-dark mb-2">Tencent Cloud</h3>
              <p className="text-text-secondary text-sm mb-4">Gaming and media optimized cloud with global CDN coverage.</p>
              <ul className="text-left text-sm text-text-secondary space-y-2">
