        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Lake Flexibility</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">Warehouse Performance</h3>
              <p className="text-text-secondary">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-3">AI-Ready Architecture</h3>
              <p className="text-text-secondary">
      ...
      <section className="section-padding bg-bg-lighter">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">Multi-Format Support</h3>
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">ACID Transactions</h3>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">Query Optimization</h3>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
            ...
            <div className="card">
              <h3 className="text-xl font-semibold text-text-dark mb-4">Scalability</h3>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-orange mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold text-text-dark mb-2">Alibaba Cloud MaxCompute</h3>
              <p className="text-text-secondary text-sm">Enterprise data warehousing with petabyte-scale analytics capabilities.</p>
            </div>

            <div className="card text-center">
              <div className="text-4xl mb-4">🌐</div>
              <h3 className="text-xl font-semibold text-text-dark mb-2">Huawei Cloud DWS</h3>
              <p className="text-text-secondary text-sm">Cloud data warehouse with high performance and elasticity.</p>
            </div>

            <div className="card text-center">
              <div className="text-4xl mb-4">🚀</div>
              <h3 className="text-xl font-semibold text-text-dark mb-2">Tencent Cloud EMR</h3>
              <p className="text-text-secondary text-sm">Managed Hadoop/Spark for big data processing and analytics.</p>
            </div>
          </div>
        </div>
      </section>
