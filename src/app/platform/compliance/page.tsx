        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">GDPR</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">SOC 2</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">HIPAA</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">OJK Compliance</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">ISO 27001</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold text-[#1A1A1A] mb-3">PCI DSS</h3>
              <p className="text-gray-600 mb-4">
