        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="card text-center">
              <div className="text-5xl font-bold gradient-text mb-2">Continuous</div>
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-2">Availability</h3>
              <p className="text-gray-600 text-sm">Enterprise-grade availability with multi-region redundancy.</p>
            </div>
      ...
      {/* <section className="section-padding bg-gradient-to-br from-[#E31E24] to-[#1A1A1A]">
        <div className="container-custom text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Implement enterprise-grade disaster recovery designed for continuous availability.
          </p>
