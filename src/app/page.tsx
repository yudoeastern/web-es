  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-bg-light">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white via-bg-light to-white"></div>

        {/* Animated mesh gradient overlay */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Large gradient orbs */}
          <div className="absolute top-0 left-0 w-[800px] h-[800px] bg-gradient-to-br from-primary-orange/5 to-transparent rounded-full blur-3xl animate-blob"></div>
          <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-gradient-to-tl from-accent-blue/5 to-transparent rounded-full blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-primary-orange-light/5 to-accent-blue/5 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
          
          {/* Subtle grid pattern overlay */}
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
        </div>
      ...
      <section className="section-padding bg-bg-light-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/solutions/ai/autonomous-agents" className="card group">
              ...
              <h3 className="text-2xl font-semibold text-text-dark mb-3 group-hover:text-[#E31E24] transition-colors">
                Autonomous AI Agents
              </h3>
              <p className="text-text-secondary mb-4">
                Self-governing AI agents that operate independently across business workflows and systems.
              </p>
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#E31E24]/90 to-[#1A1A1A]/95 z-10"></div>
          <img 
            src="/bg_section_bawah.webp" 
